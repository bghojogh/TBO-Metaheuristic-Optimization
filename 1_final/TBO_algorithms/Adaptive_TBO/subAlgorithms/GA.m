...
function [time_betterSolutionFound, bestFitnessArray, bestFitness, bestFitnessCoordinate] = GA(x,y,z, ChromosomsNum, step, x_min, x_max, y_min, y_max, GlobalIterationNum, disp_figures_and_results)
