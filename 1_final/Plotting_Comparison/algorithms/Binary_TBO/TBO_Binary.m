...
function [bestFitnessArray] = TBO_Binary(x,y,z, ParticlesNum, step, GlobalIterationNum, disp_figures_and_results, sub_algorithm)
...
for globalIteration = 1:GlobalIterationNum
    ...
    iterationLocalSearch_simpleLocalSearch = 200;
