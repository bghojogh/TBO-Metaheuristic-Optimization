...
function [time_betterSolutionFound, bestFitnessArray, GlobalBestFitness, GlobalBestCoordinate] = PSO(x,y,z, ParticlesNum, step, x_min, x_max, y_min, y_max, GlobalIterationNum, iterationLocalSearch, disp_figures_and_results)
    ...
    for i = 1:ParticlesNum
        ...
        if globalIteration~=1  
            ...
            while 1
                ...
                if counter == 200
                    ParticleLoc(1,i) = x_min + (x_max - x_min)*rand;
                    ParticleLoc(2,i) = y_min + (y_max - y_min)*rand;
                    break
                end
            end
        end
